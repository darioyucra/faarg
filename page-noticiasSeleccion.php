<?php /* Template Name:NoticiasSeleccion*/ ?>
<?php get_header(); ?>
<script>
...
<section class="notasPrincipal">
                ...
                */?>
                <?php $the_query = new WP_Query( 'cat=49&showposts=-1' ); ?>
