...
<div class="espacioNoticias">
    ...
    if(validarOsos !== -1){
        ...
        document.querySelector("#principal > div.contenidoRoster > section > article > div.gridTabla > div.sp-section-content.sp-section-content-data > h4").style.backgroundColor = "#003B75!important";
    }
