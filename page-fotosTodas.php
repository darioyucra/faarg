...
<div class="subMenuSection">
    <nav>
        <ul>
            ...
            <li><a href="http://faarg.arlud.com/?page_id=63599">Juveniles</a></li>
...
if(tituloBannerFotos.innerHTML == 'Fotos Todas'){
    quitarIdSubMenu();
    botonesSubMenuFotos[0].id = 'submenuActivo';
}else if(tituloBannerFotos.innerHTML == 'Fotos Mayores'){
    quitarIdSubMenu();
    botonesSubMenuFotos[1].id = 'submenuActivo';
}else if(tituloBannerFotos.innerHTML == 'Fotos Juveniles'){
    quitarIdSubMenu();
