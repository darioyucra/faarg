<?php /* Template Name:NoticiasMayores*/ ?>
<?php get_header(); ?>
<script>
...
<div class="subMenuSection">
    <nav>
        <ul>
            ...
            <li id="submenuActivo"><a href="http://faarg.arlud.com/?page_id=63618">Mayores</a></li>
...
<section class="notasPrincipal">
                ...
                */?>
                <?php $the_query = new WP_Query( 'cat=44&showposts=-1' ); ?>
