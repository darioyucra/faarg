<?php /* Template Name:NoticiasJuveniles*/ ?>
<?php get_header(); ?>
<script>
...
<div class="subMenuSection">
    <nav>
        <ul>
            ...
            <li id="submenuActivo"><a href="http://faarg.arlud.com/?page_id=63620">Juveniles</a></li>
...
<section class="notasPrincipal">
                ...
                */?>
                <?php $the_query = new WP_Query( 'cat=43&showposts=-1' ); ?>
